  ...
  return (
    <div>
      ...
      <div className="w-full rounded-lg overflow-hidden min-h-screen font-sans bg-white text-black px-4 md:p-8 meSection">
        <h1 className="text-xl sm:text-2xl font-[Syncopate] max-w-5xl mx-auto">
          We can work together
        </h1>
        <div className="max-w-5xl mx-auto my-6 md:my-12 flex flex-col lg:flex-row justify-between gap-8 items-center">
          ...
          <div className="text-lg sm:text-xl md:text-2xl flex justify-between  lg:flex-col space-x-8">
            <div>
              <h1 className="font-semibold text-xl sm:text-2xl mb-3">
                My Stack:
              </h1>
              <p>
                <span className="text-blue-700 font-semibold">Frontend:</span>{" "}
                React, NextJs
              </p>
              <p>
                <span className="text-blue-700 font-semibold">Backend:</span>{" "}
                Django, DRF
              </p>
              <p>
                <span className="text-blue-700 font-semibold">Animation:</span>{" "}
                GSAP, R3F
              </p>
            </div>
            <div className="lg:mt-6">
              <h1 className="font-semibold text-xl sm:text-2xl mb-3 lg:mt-6">
                Contact Me:
              </h1>
              <p>
                <span className="text-blue-700 font-semibold">Cell:</span>{" "}
                +8801317482129
              </p>
              <p>
